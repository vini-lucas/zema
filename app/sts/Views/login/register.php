...
<form method="POST" action="" autocomplete="off" id="form-register">
    ...
    ?>
    <label>CPF:</label>
    <input type="text" name="cpf" value="<?php echo $cpf_value; ?>" id='cpf' placeholder="XXX.XXX.XXX-XX" maxlength="14" autocomplete="off"><br><br>
    ...
    <input type="text" name="telephone" value="<?php echo $telephone_value; ?>" id='telephone' placeholder="(XX) 9 XXXX-XXXX" maxlength="16" autocomplete="off"><br><br>
    ...
    ?>
    <label>E-mail:</label>
    <input type="text" name="email" value="<?php echo $email_value; ?>" id='email' placeholder="seu_nome@dominio.com" autocomplete="off">
