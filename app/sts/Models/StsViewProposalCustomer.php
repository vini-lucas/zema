...
class StsViewProposalCustomer
{
    ...
    public function searchDataPp(int $id)
    {
        ...
        $searchDataPp->fullRead("SELECT cpf, name, date_birth, value_released, prime_portion, second_portion, third_portion, fourth_portion, fifth_portion, sixth_portion, seventh_portion, eightth_portion, nineth_portion, tenth_portion FROM sts_proposal_fgts WHERE id=:id", "id={$id}");
