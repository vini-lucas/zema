...
abstract class Config 
{
    ...
    {
//Páginas Públicas: -----------------------------------------------------------------------------------------
        define('PAGES_PUBLICS', ["Login", "Register", "ConfEmail", "RecPassword", "NewPassword", "NewEmail"]);
//------------------------------------------------------------------------------------------------------------
//Páginas Públicas: -----------------------------------------------------------------------------------------
...
//------------------------------------------------------------------------------------------------------------
        ...
        define('CONTROLLER_NOT_CONTROLLER', 'Login'); // -> O que a Controller recebe se não haver controller informada na URL.
...
// Mensagens: ------------------------------------------------------------------------------------------------
        ...
        define('MSG_PERFOM_LOGIN', "<p style='color: red;'>Realize o login para obter acesso à página!</p>"); 
        ...
        define('MSG_PAGE_NOT_FOUND', "<p style='color: red'>Página não encontrada!</p>");

        define('MSG_ERR_PAGE_NOT_FOUND_404', 'Erro 404: Página não encontrada! Caso o erro persista, acione o suporte pelo e-mail: ' . '"' . EMAILADM . '"' . '.');   
        define('MSG_ERR_PAGE_NOT_FOUND_333', '<p style="color: red">Erro 333: Página não encontrada! Caso o erro persista, acione o suporte pelo e-mail: </p>');
        define('MSG_ERR_PAGE_NOT_FOUND_639', 'Erro 639: Página não encontrada! Caso o erro persista, acione o suporte pelo e-mail: ' . '"' . EMAILADM . '"' . '.');
        define('MSG_ERR_PAGE_NOT_FOUND_527', 'Erro 527: Página não encontrada! Caso o erro persista, acione o suporte pelo e-mail: ' . '"' . EMAILADM . '"' . '.');
        ...
        define("MSG_NECE_LOGIN_ACCESS_PAGE", "<p style='color: red;'>Realize o login para obter acesso à página!</p>");
// -----------------------------------------------------------------------------------------------------------
    }
}
